...
<link rel="stylesheet" type="text/css"
	...
	//选择模板按钮跳转页面
		...
		function selModel(){//进入查看业务信息页面
			queryBusi = layer.open({
				...
				maxmin: true,
				area : ['850px', '580px'],
				content : '<%=path%>/business/forward/gotoBusinessView?pageName=selModelByOrgId&processId='+processId+'&orgId='+orgId,
	...
	function closeFrame(){
		var processId = $("#processId").val();
		window.location.href='<%=path%>/supervisory/forward/getNodeInfo?processId='+processId;
	}
	...
	function saveProcessInfo(){
		...
		$.post('<%=path%>/business/asyn/saveProcessInfo',{
			...
			<div style="margin-bottom:15px;">
				<table>
					...
					<tr>
						...
						<td>
							<select id="ser_type_input" name="ser_type_input" onchange="queryMessage();" style="border:1px solid #ccc;width:140px;height:26px;">
								<% 
									String processType=(String)request.getParameter("processType");
									System.out.print(processType);
							        if(processType!=null&&processType.equals("200101")){
							        	%>
							        	...
							        	<% 
							        }else if(processType!=null&&processType.equals("200100")){
							        	%>
							        	<option value="200101">代理记账</option>
										<option value="200100" selected="selected">工商注册</option>
										<option value="200102">法律咨询</option>
										<option value="200103">人事代理</option>
										<option value="200104">商标专利</option>
										<option value="200105">其他</option>	
							        	<% 
							        }else if(processType!=null&&processType.equals("200102")){
							        	%>
							        	<option value="200101">代理记账</option>
										<option value="200100">工商注册</option>
										<option value="200102" selected="selected">法律咨询</option>
										<option value="200103">人事代理</option>
										<option value="200104">商标专利</option>
										<option value="200105">其他</option>	
							        	<% 
							        }else if(processType!=null&&processType.equals("200103")){
							        	%>
							        	<option value="200101">代理记账</option>
										<option value="200100">工商注册</option>
										<option value="200102">法律咨询</option>
										<option value="200103" selected="selected">人事代理</option>
										<option value="200104">商标专利</option>
										<option value="200105">其他</option>
							        	<% 
							        }else if(processType!=null&&processType.equals("200104")){
							        	%>
							        	<option value="200101">代理记账</option>
										<option value="200100">工商注册</option>
										<option value="200102">法律咨询</option>
										<option value="200103">人事代理</option>
										<option value="200104" selected="selected">商标专利</option>
										<option value="200105">其他</option>
							        	<% 
							        }else if(processType!=null&&processType.equals("200105")){
							        	%>
							        	<option value="200101">代理记账</option>
										<option value="200100">工商注册</option>
										<option value="200102">法律咨询</option>
										<option value="200103">人事代理</option>
										<option value="200104">商标专利</option>
										<option value="200105" selected="selected">其他</option>
							        	<% 
							        }else{
							        	%>
							        	<option value="200101">代理记账</option>
