...
$(function(){
	$("#processTable").jqGrid({                   
		url: '<%=path%>/business/forward/gotoBusinessModelAddNode?processTmpId='+$("#value").val(),
		contentType: 'application/json',
		datatype: 'json',
		colNames: ['id','proId','mngId','idDelete','节点名称'],
		colModel: [
			{name:'id',index:'id',sortable:false,hidden:true},
			{name:'stamp',index:'stamp',sortable:false,hidden:true},
...
<input type="hidden" id="value" name="value" value="${requestScope.value}"/>
</body>  
</html>